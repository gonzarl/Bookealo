...
[Migration("20250818231344_Create_Database")]
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("CleanBookings.Domain.Bookings.Booking", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid")
        ...
        modelBuilder.Entity("CleanBookings.Domain.Reviews.Review", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid")
        ...
        modelBuilder.Entity("CleanBookings.Domain.Apartments.Apartment", b =>
            {
                b.OwnsOne("CleanBookings.Domain.Apartments.Address", "Address", b1 =>
                    {
                ...
                b.OwnsOne("CleanBookings.Domain.Shared.Money", "CleaningFee", b1 =>
                    {
                        b1.Property<Guid>("ApartmentId")
                            .HasColumnType("uuid")
                            .HasColumnName("id");
                ...
                b.OwnsOne("CleanBookings.Domain.Shared.Money", "Price", b1 =>
                    {
                        b1.Property<Guid>("ApartmentId")
                            .HasColumnType("uuid")
                            .HasColumnName("id");
        ...
        modelBuilder.Entity("CleanBookings.Domain.Bookings.Booking", b =>
            {
                b.HasOne("CleanBookings.Domain.Apartments.Apartment", null)
                    .WithMany()
                    .HasForeignKey("ApartmentId")
                ...
                b.OwnsOne("CleanBookings.Domain.Shared.Money", "AmenitiesUpCharge", b1 =>
                    {
                ...
                b.OwnsOne("CleanBookings.Domain.Shared.Money", "PriceForPeriod", b1 =>
                    {
                        b1.Property<Guid>("BookingId")
                            .HasColumnType("uuid")
                            .HasColumnName("id");
                ...
                b.OwnsOne("CleanBookings.Domain.Shared.Money", "TotalPrice", b1 =>
                    {
                        b1.Property<Guid>("BookingId")
                            .HasColumnType("uuid")
                            .HasColumnName("id");
                ...
                b.OwnsOne("CleanBookings.Domain.Bookings.DateRange", "Duration", b1 =>
                    {
                        b1.Property<Guid>("BookingId")
                            .HasColumnType("uuid")
                            .HasColumnName("id");
        ...
        modelBuilder.Entity("CleanBookings.Domain.Reviews.Review", b =>
            {
                ...
                b.HasOne("CleanBookings.Domain.Bookings.Booking", null)
                    .WithMany()
                    .HasForeignKey("BookingId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired()
